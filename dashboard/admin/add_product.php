        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="text-center mt-4">Products Details</h1>
                </div>
            </main>
            </br></br>
            <div class=" row">
                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder=" Product Title" class="form-control" require />
                            </div>
                            <div class="form-group">
                                <label>Prices</label>
                                <input type="text" name="price" placeholder="Prices" class="form-control" require />
                            </div>
                            <!-- <div class="form-group">
                                <label>Image</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="Cat_Id" placeholder="Category_ID" class="form-control" require />
                            </div>

                            <div class="form-group">
                                <label>Product Description</label>
                                <input type="text" name="Product_desc" placeholder="Product Description" class="form-control" require />
                            </div>
